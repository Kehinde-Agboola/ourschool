...
export default function Nav() {
  ...
  return (
    <div className="bg-white">
      <div className=" flex justify-between items-center  max-w-6xl mx-auto px-8 md:px-0 py-4">
        ...
        <div className=" items-center  gap-[1.5rem] hidden xl:flex ">
          ...
          <div className="flex items-center gap-[1.5rem]">
            <Link
              href={"/auth/register"}
              className="bg-blue-100 text-white py-3 px-5 rounded-full"
            >
              Start Learning
            </Link>
            <Link
              href={"/auth/Login"}
              className="text-blue-100 py-3 px-5 border-2 rounded-full"
            >
              Login
            </Link>
          </div>
